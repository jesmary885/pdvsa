...
>
    <span class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 sm:text-sm">
        <svg class="h-5 w-5 text-gray-400 ml-2" fill="currentColor" viewBox="0 0 20 20">
    ...
    />
</div><?php /**PATH C:\xampp\htdocs\pdvsa\resources\views/components/input/date.blade.php ENDPATH**/ ?>